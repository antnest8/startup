                ...
                <div class="flex flex-row justify-center grow">
                    <div class="flex flex-col p-8 px-12 bg-stone-800 rounded-md grow max-w-[70dvw] max-h-[90dvw] mb-6 mt-2">
                        <div class="flex justify-center">
                            <div class="flex flex-col mt-[1em] max-w-100 grow">
                                <div>
                                    <h3 id="user-email">Email: </h3>
                                    <p class="max-w-100 bg-stone-900 outline-2 outline-solid outline-stone-700 rounded-full text-stone-300 pl-2" id="user-email-output">youremail@example.com</p>
                                </div>
                        ...
                        <div class="flex justify-center">
                            <div class="flex flex-col mt-[1em] max-w-100 grow">
                                <div>
                                    ...
                                    <p class="max-w-100 bg-stone-900 outline-2 outline-solid outline-stone-700 rounded-full text-stone-300 pl-2" id="user-name-output">youremail@example.com</p>
                                </div>
                                <div class="flex justify-end">
                        ...
                        <div class="flex justify-center">
                            <div class="flex flex-col mt-[1em] max-w-120 grow relative left-10">
                                <label for="user-password">Password: </label>
                                <div class="flex">
                                    <input class=" bg-stone-900 outline-2 outline-solid outline-stone-700 rounded-full text-stone-300 pl-2 grow" type="password" disabled="true" id="user-password" value="password123"/> 
                                    <button class="bg-stone-500 border-stone-600 max-w-[8em] min-w-[5em] rounded-md border-solid border-2 min-h-[2em] text-sm ml-[10px] hover:bg-stone-700" id="password-visibility-toggle">🙈/🙉</button>
                                </div>
                                <div class="flex justify-end">
                                    <button class="flex relative right-20 justify-end text-xs text-stone-400 hover:text-cyan-800" id="change-password-button" type="button">Change password</button>
                                </div>
                            </div>
                        </div>
                    </div>
