            ...
            <section className="flex bg-stone-800 rounded-md justify-evenly w-[700px] max-w-[700px]" id="input-form-section">
                <form className="flex flex-col grow mx-4" action="app" method="get" id="signup-form">
                    ...
                    <div className="flex flex-col my-2">
                        <label className="text-xs" for="signup-email">Email:</label>
                    ...
                    <div className="flex flex-col my-2">
                        <label className="text-xs" for="signup-name">Display Name:</label>
                    ...
                    <div className="flex flex-col my-2">
                        <label className="text-xs" for="signup-password">Password:</label>
                ...
                <form className="flex flex-col grow mx-4" action="app" method="get" id="login-form">
                    ...
                    <div className="flex flex-col my-3">
                        <label className="text-xs" for="login-name">Display Name:</label>
                    ...
                    <div className="flex flex-col my-3">
                        <label className="text-xs" for="login-password">Password:</label>
